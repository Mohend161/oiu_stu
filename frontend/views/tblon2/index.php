...
<div class="tblon-index">
    ...
    <p>
	     <?= Html::a('<span class=" btn btn-success"> إضافة عهده</span>', ['/tblon/create'], [ 'class' => 'activity-view-link1']);?>																		
    </p>
    ...
    <?= GridView::widget([
       ...
       [
                ...
                'urlCreator' => function ($action, $model) {
                    if ($action === 'update') {
                        $url = Url::to(['tblon2/update', 'id' => $model->LonID]);
                        return $url;
                    }if ($action === 'view') {
                        $url = Url::to(['tblon2/view', 'id' => $model->LonID]);
                        return $url;
                    }if ($action === 'delete') {
                        $url = Url::to(['tblon2/delete', 'id' => $model->LonID]);
                        return $url;
                    }
                }
            ],
